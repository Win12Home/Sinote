...
debugLog: Callable = lambda content: (
    Logger.debug(content, "ProjectSettingGet&WriterActivity") if debugMode else None
)
...
class ProjectSettings:
    ...
    def __sync(self) -> None:
        ...
        try:
            ...
            normalLog(
                2,
                f"Error: Synchronize Project Setting failed: {e!r} (for a known python traceback)",
            )
        else:
    ...
    def getProjectSettings(self) -> dict[Any, Any] | None:
        ...
        try:
            ...
            normalLog(2, f"Cannot read settings: {e!r}")
            return None
        else:
        ...
        try:
            ...
            normalLog(2, f"Failed to convert string to dict: {e!r}")
